...
//! error mapping, claims projection, discovery document assembly, the pure
//! authorize/token decisions, the endpoint handlers, and the hand-written
//! `AuthPlugin` implementation generic over
...
pub use handlers::{LoginRedirectHook, OidcProviderConfig, OidcProviderPlugin};
